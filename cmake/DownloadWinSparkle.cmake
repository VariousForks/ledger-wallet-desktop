...
function(DownloadWinSParkle version download_dir)
  # Specify the binary distribution type and download directory.
  set(CEF_DISTRIBUTION "WinSparkle-${version}")
  ...
  if(NOT IS_DIRECTORY "${CEF_ROOT}/${CEF_DISTRIBUTION}") 
    set(CEF_DOWNLOAD_FILENAME "${CEF_DISTRIBUTION}.zip")
    set(CEF_DOWNLOAD_PATH "${CEF_DOWNLOAD_DIR}/${CEF_DOWNLOAD_FILENAME}")
    if(NOT EXISTS "${CEF_DOWNLOAD_PATH}")
      set(CEF_DOWNLOAD_URL "https://github.com/vslavik/winsparkle/releases/download/v${version}/${CEF_DOWNLOAD_FILENAME}")
